...
'@jupyterlab/csvviewer$': require.resolve(path.resolve('../../packages/csvviewer')),
'@jupyterlab/csvviewer-extension$': require.resolve(path.resolve('../../packages/csvviewer-extension')),
...
'@jupyterlab/extensionmanager$': require.resolve(path.resolve('../../packages/extensionmanager')),
'@jupyterlab/extensionmanager-extension$': require.resolve(path.resolve('../../packages/extensionmanager-extension')),
...
'@jupyterlab/javascript-extension$': require.resolve(path.resolve('../../packages/javascript-extension')),
'@jupyterlab/json-extension$': require.resolve(path.resolve('../../packages/json-extension')),
...
'@jupyterlab/markdownviewer$': require.resolve(path.resolve('../../packages/markdownviewer')),
'@jupyterlab/markdownviewer-extension$': require.resolve(path.resolve('../../packages/markdownviewer-extension')),
'@jupyterlab/mathjax2$': require.resolve(path.resolve('../../packages/mathjax2')),
'@jupyterlab/mathjax2-extension$': require.resolve(path.resolve('../../packages/mathjax2-extension')),
...
'@jupyterlab/pdf-extension$': require.resolve(path.resolve('../../packages/pdf-extension')),
...
'@jupyterlab/terminal$': require.resolve(path.resolve('../../packages/terminal')),
'@jupyterlab/terminal-extension$': require.resolve(path.resolve('../../packages/terminal-extension')),
...
'@jupyterlab/toc$': require.resolve(path.resolve('../../packages/toc')),
'@jupyterlab/toc-extension$': require.resolve(path.resolve('../../packages/toc-extension')),
...
'@jupyterlab/vdom$': require.resolve(path.resolve('../../packages/vdom')),
'@jupyterlab/vdom-extension$': require.resolve(path.resolve('../../packages/vdom-extension')),
'@jupyterlab/vega5-extension$': require.resolve(path.resolve('../../packages/vega5-extension')),
